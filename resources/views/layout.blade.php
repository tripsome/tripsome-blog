...
<head>
    ...
    <!-- Style sheets-->
    @if(@auth('blog')->user()->meta['theme'] == 'dark')
        <link href='{{mix('dark.css', 'vendor/blog')}}' rel='stylesheet' type='text/css'>
...
<!-- Global Blog Object -->
<script>
    window.Blog = @json($blogScriptVariables);
</script>

<script src="{{mix('app.js', 'vendor/blog')}}"></script>
</body>
</html>
