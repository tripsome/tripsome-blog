        ...
        methods: {
            ...
            fillForm(data) {
                ...
                if (this.id != 'new') {
                    ...
                    this.form.parent = data.parent_id || '';
    ...
    <div>
        ...
        <modal v-if="settingsModalShown" @close="settingsModalShown = false">
            ...
            <div class="input-group">
                ...
                <form-errors :errors="errors.lang"></form-errors>
            </div>

            <div v-show="form.parent != 'EN'" class="input-group">
                <label for="parent" class="input-label">Translation for</label>
                <select name="parent" class="input"
                        v-model="form.parent"
                        id="parent">
                    <template v-for="page in pages">
                        <option v-if="page.lang == 'EN'" :value="page.id" >{{page.title}}</option>
                    </template>
                </select>
                <form-errors :errors="errors.parent"></form-errors>
            </div>
